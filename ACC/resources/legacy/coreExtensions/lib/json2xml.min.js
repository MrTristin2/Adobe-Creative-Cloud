/* eslint-disable */
/*
* Portions copyright (c) 2014 Adobe Systems Incorporated.
*
* This function is a wrapper function to the X2JS library
* by Abdulla Abdurakhmanov (https://code.google.com/p/x2js/)
* It returns the required xml string which is returned using
* the json2xml_string function call.
*/
function j2x(msg){var x2js=new X2JS;return x2js.json2xml_str(msg)}
