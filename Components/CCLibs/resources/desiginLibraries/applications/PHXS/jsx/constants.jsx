...
PSString.gradientClassEvent = sTID('gradientClassEvent');
...
PSKey.AddPatternToPresets = sTID('addPatternToPresets');
...
// Gradients
PSString.defineCustomGradient = sTID("defineCustomGradient");
PSString.applyCustomGradient = sTID("applyCustomGradient");
